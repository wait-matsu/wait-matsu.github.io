$(function () {
  ...
  const newsList = {
    202021120: {
      date: '2020.11.20',
      genre: 'update',
      title: '【ver1.7.33】アップデートが配信されました。（リリースノートはアプリからご確認ください）',
    },
    202021109: {
      date: '2020.11.09',
      genre: 'update',
      title: '【ver1.7.29】アップデートが配信されました。（リリースノートはアプリからご確認ください）',
    },
    202021022: {
      date: '2020.10.22',
      genre: 'event',
    ...
    202020926: {
      date: '2020.09.26',
      genre: 'update',
      title: '【ver1.7.13】アップデートが配信されました。（リリースノートはアプリからご確認ください）',
    },
    202020913: {
      date: '2020.09.13',
      genre: 'event',
